...
import com.jinosoft.restapi.section02.responseentity.ResponseMessage;
...
*  LV 1 : 자원 개념만 도입
*  LV 2 : HTTP 메서드를 활용(GET, POST, PUT, DELETE, PATCH) + 상태 코드
*  LV 3 : 응답본문에 다음 수행할 수 있는 링크를 포함 Hateoas를 활용
* * */
@RestController

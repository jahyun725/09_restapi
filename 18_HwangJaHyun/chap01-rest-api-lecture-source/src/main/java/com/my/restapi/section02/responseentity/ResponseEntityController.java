package com.my.restapi.section02.responseentity;
...
public class ResponseEntityController {
  ...
  public ResponseEntity<ResponseMessage> findAllUsers(){
    ...
    * */
    ...
    /*return new ResponseEntity<>(responseMessage, httpHeaders, HttpStatus.OK);*/ // 권장 X

    /* 추천하는 responseEntity 정적 메서드 방식(빌더 패턴, 객체를 만들어나가는 패턴)*/

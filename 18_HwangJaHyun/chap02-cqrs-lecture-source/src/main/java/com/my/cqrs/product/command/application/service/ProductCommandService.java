package com.my.cqrs.product.command.application.service;

import com.my.cqrs.common.service.FileStorageService;
import com.my.cqrs.exception.BusinessException;
import com.my.cqrs.exception.ErrorCode;
...
import com.my.cqrs.product.command.domain.aggregate.ProductStatus;
...
public class ProductCommandService {
  ...
  public Long createProduct(ProductCreateRequest productCreateRequest, MultipartFile productImg) {
    ...
    // AutoIncrement로 생성된 productCode가 담겨있음
  ...
  public void deleteProduct(Long productCode){
    ...
    * Product entity에 정의 된 @SQLDelete 어노테이션에 의해

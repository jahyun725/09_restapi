package com.my.cqrs.product.query.service;

import com.my.cqrs.common.dto.Pagination;
...
import com.my.cqrs.product.query.dto.response.ProductDTO;
...
import com.my.cqrs.product.query.mapper.ProductMapper;
...
public class ProductQueryService {
  ...
  /* 읽기 전용 트랜잭션을 이용해서 성능 최적화 + 실수로 데이터 변경(Insert,Update...) 방지 */

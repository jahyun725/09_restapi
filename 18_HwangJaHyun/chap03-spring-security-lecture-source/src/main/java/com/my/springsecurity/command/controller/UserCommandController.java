package com.my.springsecurity.command.controller;

import com.my.springsecurity.command.dto.UserCreateRequest;
import com.my.springsecurity.command.service.UserCommandService;
...
public class UserCommandController {
  ...
  public ResponseEntity<ApiResponse<Void>> register(
    ...
    return ResponseEntity.status(HttpStatus.CREATED) // 201 Create (삽입/저장) 성공

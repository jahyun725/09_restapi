package org.ho.restapi.section04.hateoas;

import org.ho.restapi.section02.responseEntity.ResponseMessage;
 ...
 *   (API 진화에 유연하게 대응할 수 있다) == URL 유지보수(진화)에 용이
 *
 * - REST API 성숙도 모델 (0~3레벨) 중 3 레벨을 달성하기 위한 기술
 * LV 0 : REST 원칙을 거의 지키지 않음
 * LV 1 : 자원 개념만 도입
 * LV 2 : HTTP Method 활용(GET, POST, PUT, DELETE ...) + 상태 코드(200,404,500)
